...
export function AddChoreDialog({
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="rounded-t-4xl sm:rounded-t-4xl px-5 pt-5 pb-4">
        ...
        <form onSubmit={handleSubmit} className="px-5 py-5 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-neutral-200 rounded-2xl px-4 py-3 bg-white text-neutral-800 placeholder:text-neutral-300 outline-none focus:border-neutral-800 transition-colors"
              autoFocus={!chore}
            />
          </div>
